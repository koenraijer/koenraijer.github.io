...
Ik ben gefopt door een robot. Het was deze <a target="_blank" rel="noopener" href="https://open.spotify.com/episode/782joccUG2sI8i063zOwfT?si=Mek5vJXkTtefRstBGpYR0Q">podcast</a>. Die bleek namelijk door een algoritme gegeneerd te zijn. De boosdoener is GPT-3, een uit de kluiten gewassen chatbot: de grootste, de beste en de nieuwste. Een neural network, een AI, een deep learning algoritme. Allemaal woorden die vaak voorbij komen, maar waar ik niet écht iets over weet. Ik wilde er meer over weten. In deze post onderzoek ik wát GPT-3 precies is, hoe het werkt, wat het kan (en niet kan) en waar we het voor kunnen gebruiken, vanuit een (lichte) medische invalshoek.<!--more-->

Ik vraag me af of de Singulariteit dan toch nabij is? Wanneer gaat GPT-3 mijn baan overnemen? 
"Onzin", zeiden de dokters in het panel van het "AI op de IC"-congres. "Een klinisch probleem is bijna niet in data uit te drukken; zieke en kwetsbare patiënten zullen nooit door een robot behandeld kunnen worden", zei een van de panelleden.<br> Hoewel ik denk dat daar een kern van waarheid in schuilt, is de kous daarmee niet af. Ik verwacht namelijk dat de introductie van AI in de gezondheidszorg met kleine stapjes zal plaatsvinden. Kunstmatige intelligentie zal ons eerst de simpele taken uit handen nemen. Dat geldt ook voor taalmodellen zoals GPT-3. Die zullen langzaam betrokken raken bij screening, monitoring of lichte triage, en veel later pas bij diagnostiek en beleid. Er komt geOmdat niemand achter de feiten wil aanlopen, moeten we nu al op zoek gaan naar de vragen die we moeten stellen. 
...
<input type="checkbox"
       id="mn-graph"
       class="margin-toggle"/>
<span class="marginnote">Visuele weergave van de architectuur van GPT-3. Bron: <a href="https://www.youtube.com/watch?v=MQnJZuBGmSQ&t=325s" target="_blank">dit filmpje</a>.</span>
...
<input type="checkbox"
       id="mn-chat"
       class="margin-toggle"/>
<span class="marginnote">GPT-3 geeft advies over mentale gezondheid. <a href="https://www.nabla.com/blog/gpt-3/" target="_blank">Bron</a></span>
![Chat met GPT-3; het algoritme geeft advies over mnetale gezondheid.](/assets/images/2021-04-22-GPT3/GPT-3-medisch.jpg).
...
<footer>– Anders Sandberg, Senior Research Fellow bij Oxford University<label for="sn-src2" class="margin-toggle sidenote-number"></label>
<input type="checkbox"
       id="sn-src2"
       class="margin-toggle"/>
</footer></blockquote><span class="sidenote">Tweeted by: Sandberg, Anders (@anderssandberg). 20-07-2020, 8:49 AM. <a href="https://twitter.com/anderssandberg/status/1285104499531698176?s=20" target="_blank">Link to Tweet.</a></span>
...
## Epiloog
<i>... medische R2D2's strooien te midden van nasmeulende ruïnes met gevoelsreflecties rond. Niet-biologisch medische specialisten, noemen zij zichzelf. "Chatbot" vinden ze denigrerend. De grote verzekeraars zijn vol lof.</i>
